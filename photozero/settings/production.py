...
AWS_ACCESS_KEY_ID = os.environ['AKIAIB34RHLINXD54E4Q']
AWS_SECRET_ACCESS_KEY = os.environ['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']
...
AWS_STORAGE_BUCKET_NAME = os.environ['photozerobasic']
